...
def get_opts():
    ...
    ###########################
    #### Params for Fourier Embedding ####
    parser.add_argument("--freq_xyz", type=int, default=10, help="frequency for xyz")
    parser.add_argument("--freq_dir", type=int, default=4, help="frequency for dir")
    ###########################
